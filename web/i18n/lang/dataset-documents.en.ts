const translation = {
  list: {
    title: 'Documents',
    desc: 'All files of the Knowledge are shown here, and the entire Knowledge can be linked to EduAI citations or indexed via the Chat plugin.',
    addFile: 'add file',
    addPages: 'Add Pages',
    table: {
      header: {
    ...
    empty: {
      ...
      sync: {
        tip: 'EduAI will periodically download files from your Notion and complete processing.',
      },
    },
    delete: {
