const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'EduAI account',
    langGeniusAccountTip: 'Your EduAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to EduAI to access your team data.',
  ...
  apiBasedExtension: {
    title: 'API-based extensions provide centralized API management, simplifying configuration for easy use across EduAI\'s applications.',
