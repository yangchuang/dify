const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'EduAI 账号',
    langGeniusAccountTip: '您的 EduAI 账号和相关的用户数据。',
    editName: '编辑名字',
  ...
  members: {
    ...
    invitationSentTip: '邀请已发送，对方登录 EduAI 后即可访问你的团队数据。',
    invitationLink: '邀请链接',
  ...
  apiBasedExtension: {
    title: 'API 扩展提供了一个集中式的 API 管理，在此统一添加 API 配置后，方便在 EduAI 上的各类应用中直接使用。',
